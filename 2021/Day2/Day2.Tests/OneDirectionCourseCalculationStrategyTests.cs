...
{
    public class OneDirectionCourseCalculationStrategyTests
    {
        private SubmarineCoursePlanner submarine = null!;
        [SetUp]
        public void Setup()
        {
            submarine = new SubmarineCoursePlanner(new OneDirectionCourseCalculationStrategy());
        }
        ...
        {
            submarine.CalculateFinalPosition(new[] { "forward 5", "down 10" });
        ...
        {
            submarine.CalculateFinalPosition(new[] { "forward 5", "up 10" });
